...
<div class="modal-footer"><button id="cancel_address_validation" class="btn btn-default" type="button" data-dismiss="modal">Cancel</button></div>
</div>
</div>
</div>
<section id="donation">
<div id="donation-form" class=""><form role="form" id="alpaca3" data-alpaca-form-id="alpaca3" class="alpaca-form">
    ...
    <div class="help-block alpaca-message alpaca-message-notOptional">
        ...
        <div class="radio alpaca-control" name="donation_info_amount" style="display: block;">
        <label>
